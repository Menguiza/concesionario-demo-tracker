        ...
        <li key={c.id} className="bg-gray-50 rounded-lg border border-gray-100 p-2">
          <div className="flex items-center justify-between gap-2">
            ...
            {c.efectivo ? (
              ...
              <span className="text-xs rounded-full bg-gray-200 text-gray-600 px-2 py-0.5 shrink-0">Descartado: {c.motivoDescarte}</span>
            )}
          </div>
    ...
    <div className="space-y-4">
      ...
      {!puedeGestionar && (
        <p className="text-xs text-gray-500 bg-gray-100 rounded-lg p-3">
          Puedes ver el listado de clientes de cada comercial. Solo anfitriona y admin pueden marcar un cliente como no efectivo.
        </p>
      )}
